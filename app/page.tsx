...
export default function Home() {
  return (
    <main className="relative min-h-screen text-foreground">
      {/* Page-wide ambient glow — fixed behind everything */}
      <div
        aria-hidden="true"
        className="pointer-events-none fixed inset-0 -z-10"
        style={{
          background:
            "radial-gradient(50% 35% at 50% 0%, oklch(0.62 0.19 258 / 0.12), transparent 75%), radial-gradient(55% 45% at 20% 60%, oklch(0.62 0.19 258 / 0.07), transparent 75%), radial-gradient(50% 40% at 90% 95%, oklch(0.62 0.19 258 / 0.09), transparent 75%)",
        }}
      />
      ...
      {/* ── WHATSAPP CTA ───────────────────────────── */}
      <section className="border-t border-border/60 mx-auto max-w-6xl px-6 py-24">
        <div className="group relative isolate flex flex-col items-center overflow-hidden rounded-2xl border border-primary/40 bg-[oklch(0.28_0.12_258)] px-8 py-14 text-center shadow-xl shadow-primary/20 md:py-20">
          {/* Animated soft glow drifting across the card */}
          <div
            aria-hidden="true"
            className="pointer-events-none absolute inset-0 -z-10 opacity-90 animate-[ctaDrift_14s_ease-in-out_infinite]"
            style={{
              background:
                "radial-gradient(40% 60% at 20% 30%, oklch(0.62 0.19 258 / 0.55), transparent 65%), radial-gradient(45% 65% at 80% 70%, oklch(0.55 0.22 268 / 0.45), transparent 65%)",
            }}
          />
          ...
          <a
            ...
            className="mt-8 inline-flex items-center gap-2 rounded-lg bg-white px-6 py-3 text-sm font-semibold text-[oklch(0.35_0.14_258)] shadow-md transition-transform hover:-translate-y-0.5 hover:shadow-lg"
          >
            ...
            <div>
              ...
              <div className="mt-8 space-y-3 text-sm">
                <p className="text-muted-foreground">
                  ...
                  <a href="mailto:hellocorebot@gmail.com" className="text-primary transition-colors hover:text-primary/80">
        ...
        <div className="mx-auto max-w-6xl px-6 py-12">
          <div className="grid gap-10 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2 text-sm">
                <li><a href="mailto:hellocorebot@gmail.com" className="text-muted-foreground transition-colors hover:text-foreground">hellocorebot@gmail.com</a></li>
